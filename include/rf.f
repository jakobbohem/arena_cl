...
C         CALL XERMSG ('SLATEC', 'RF',
C     *      'MIN(X,Y,Z).LT.0 WHERE X = ' // XERN3 // ' Y = ' // XERN4 //
C     *      ' AND Z = ' // XERN5, 1, 1)
         write (*,*) 'slatec, rf: MIN(X,Y,Z).LT.0 WHERE X = ' // XERN3
     *   // ' Y = ' // XERN4 //
     *      ' AND Z = ' // XERN5
         RETURN
      ENDIF
...
C     *      XERN4 // ' Z = ' // XERN5 // ' AND UPLIM = ' // XERN6, 3, 1)
         write (*,*) 'slatec, rf: MAX(X,Y,Z).GT.UPLIM WHERE X = '  //
     *   XERN3 // ' Y = ' //
...
C         CALL XERMSG ('SLATEC', 'RF',
C     *      'MIN(X+Y,X+Z,Y+Z).LT.LOLIM WHERE X = ' // XERN3 //
C     *      ' Y = ' // XERN4 // ' Z = ' // XERN5 // ' AND LOLIM = ' //
C     *      XERN6, 2, 1)
         write (*,*) 'slatec, rf: MIN(X+Y,X+Z,Y+Z).LT.LOLIM WHERE X = '
     *   // XERN3 //
