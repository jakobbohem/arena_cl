!     
! File:   cl_sollision_operator.f90
! Author: jakob
!
...
MODULE cl_collision_operator
  ...
  contains
subroutine cl_mccoll_v1(peps, pp, plam, pi1, pi2, ppcdot, pacp, plcdot, paclam, temperature, zeff, lnLam)
...
!  real :: old_loop_count, test1, test2
  real ,intent(in) :: temperature, Z_eff, lnLam ! should come from globals or call to this subroutine
