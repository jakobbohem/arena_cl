...
/*  Jakob Ryden (rydenj@student.chalmers.se) modified this to do multiplication instead of a sum */

__kernel void multiply(const int size, const __global float * vec1, __global float * vec2){
